    ...
    return {
        ...
        **/
        ...
        addPdfPageToImg : async function (image_src) {
            ...
            editor.appendChild(container);
            var dataID = global._insetIntoDataset(container, image, null);
            elementOpertateFunc(dataID, container, container);
        ...
        getPdfFileContent : function(file) {
            ...
            return new Promise((resolve, reject) => {
                reader.addEventListener("load", () => {
                    const encoding = global.ExtractEncodingPdf(reader.result);
                    resolve(encoding);
                }, false);
        ...
        readData: async function (inp) {
            ...
            const options = {
                ...
                worker: "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.0.279/pdf.worker.min.js",
                scale: 2.0,
            };
            if (isSuccess) {
